...
public:
  ...
  int ReadObjects(TLorentzVector* Jet1,
		  TLorentzVector* Jet2,
 ...
 private:    
  ...
  TLorentzVector *FittedLepton;
  TLorentzVector *FittedNeutrino;
  TLorentzVector *FittedBJetH;
  TLorentzVector *FittedBJetL;
  TLorentzVector *FittedJet1;
  TLorentzVector *FittedJet2;
