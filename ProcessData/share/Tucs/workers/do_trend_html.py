    ...
    def ProcessStop(self):
        ...
        for fill in self.fill_list:
            ...
            for event in self.events1:
                ...
                if bit==2:
                    B2R=event.data['bb_rate'][0]
                    N2=event.data['nevts']
                    
                if bit==4:
                    B4R=event.data['bb_rate'][0]
                    N4=event.data['nevts']
                    
                if bit==5:
                    B5R=event.data['bb_rate'][0]
                    N5=event.data['nevts']
            ...
            for event in self.events2:
                ...
                if bit==2:
                    B2L=event.data['bb_rate'][0]

                if bit==4:
                    B4L=event.data['bb_rate'][0]
                    
                if bit==5:
                    B5L=event.data['bb_rate'][0]
            ...
            text="<td id='Code' align='center' valign='top'> <a target='_blank'  class='urllink' href='http://sviret.web.cern.ch/sviret/Images/CMS/MIB/Monitor/2011/F%d/Fill_%d_background_DQM.html' title='' rel='nofollow'><strong>%d</strong></a></td>\n"%(fill,fill,fill)
